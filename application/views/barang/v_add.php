            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Form Add Data Barang</h3>
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <?=
                        form_open_multipart('admin/barang/add')
                        ?>
                        <div class="row">
                            <div class="col-sm-12">
                                <!-- text input -->
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>Harga</label>
                                    <input type="text" class="form-control" name="harga" placeholder="Harga" value="<?= set_value('harga') ?>">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan" class="form-control" value="<?= set_value('keterangan') ?>" cols="10" rows="5"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?= base_url('admin/barang') ?>" class="btn btn-success btn-sm">Batal</a>
                        </div>
